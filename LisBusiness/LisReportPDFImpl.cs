...
namespace LisBusiness
{
    public class LisReportPDFImpl : LisReportPDF
    {
        ...
        //public void setSerialNoList(List<string> serialNos)
        //{
        //    this._serialNoList = serialNos;
        //}
        //public List<string> getSerialNoList()
        //{
        //    return this._serialNoList;
        //}
        //public void AddSerialNo(string serialNo)
        //{
        //    if (this._serialNoList == null) {
        //        this._serialNoList = new List<string>();
        //    }
        //    this._serialNoList.Add(serialNo);
        //}
        //public void AddSerialNo(List<string> serialNos)
        //{
        //    if (this._serialNoList == null)
        //    {
        //        this._serialNoList = new List<string>();
        //    }
        //    this._serialNoList.AddRange(serialNos);
        //}
